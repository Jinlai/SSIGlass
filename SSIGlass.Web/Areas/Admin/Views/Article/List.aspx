...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ext:Store runat="server" ID="DataSourceStore" IDMode="Static">
        <Proxy>
            <ext:HttpProxy Json="true" Method="GET" Url="/Admin/Article/LoadArticleList.aspx" />
        </Proxy>
        <BaseParams>
                    ...
                    <ext:Toolbar runat="server">
                        <Items>
                            <ext:Button Icon="Add" runat="server" Text="添加">
                                <Listeners>
                                    <Click Handler="win.show({ title: '文章信息添加', id: 'AddArticle', icon: 'icon-add', url: '/Admin/Article/Add.aspx' })" />
                                </Listeners>
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
    ...
    <script type="text/javascript">
        ...
        function operationCommand(command, recordData) {
            ...
            if (command == "Delete") {
                ...
                win.show({ title: '文章信息编辑', id: 'EditArticle' + articleId, icon: 'icon-tableedit', url: '/Admin/Article/Edit.aspx?articleId=' + articleId });
            }
        }
    </script>
</asp:Content>
