...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ext:Store runat="server" ID="DataSourceStore" IDMode="Static">
        <Proxy>
            <ext:HttpProxy Json="true" Method="GET" Url="/Admin/ProductRu/LoadProductRuList.aspx" />
        </Proxy>
        <BaseParams>
                    ...
                    <ext:Toolbar runat="server">
                        <Items>
                            <ext:Button Icon="Add" runat="server" Text="Product Add">
                                <Listeners>
                                    <Click Handler="win.show({ title: 'Product Add', id: 'ProductAddRu', icon: 'icon-add', url: '/Admin/ProductRu/Add.aspx' })" />
                                </Listeners>
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
        ...
        function operationCommand(command, recordData) {
            ...
            if (command == "Delete") {
                Ext.Msg.confirm("操作提示", "确定要删除该记录吗？", function(btnText) {
                    if (btnText == "yes") {
                        Ext.Ajax.request({
                            url: "/Admin/ProductRu/Delete.aspx",
                ...
                win.show({ title: '产品信息编辑', id: 'EditProductRu' + productId, icon: 'icon-tableedit', url: '/Admin/ProductRu/Edit.aspx?productId=' + productId });
            }
        }
    </script>
</asp:Content>