    ...
    <div class="ui-layout news-info">
        ...
        <div style="padding-top:20px;">
            ...
            <div class="fn-clear" style="border-bottom:1px dashed #ccc;">
                ...
                <a class="fn-right" style="margin-top:4px;width:85px;height:30px;background:url(/Content/Images/back-news-list.jpg) no-repeat 0 0;" href="<%=Url.Action("List","News", new {Area = "Russian"}) %>"></a>
            </div>            
