<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<IList<Article>>" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>News<%=ConfigurationManager.AppSettings["html_title_suffix"]%></title>
        ...
        <ul>
            ...
            <li class="fn-clear">
                ...
                <div class="fn-left news-summary">
                    ...
                    <h3><a href="<%=Url.Action("Detail","News",new {id = article.ArticleId}) %>" target="_blank"><%=article.Subject %></a></h3>
                    <p><%=article.Summary %></p>
                    <h4><a href="<%=Url.Action("Detail","News",new {id = article.ArticleId}) %>" target="_blank">Read more</a></h4>
                </div>
            </li>
            <%}%>
        </ul>
